    ...
    const edxCourses = [
      ...
      },
      {
        ...
        courses: [
          ...
          `<h2>Real-World Applications (RWAs)</h2><ul><li>Cryptocurrencies: Digital money like Bitcoin and Ethereum use blockchain technology.</li><li>Supply Chain: Companies can track products from the factory to the store, ensuring they are genuine and not tampered with.</li><li>Voting: Blockchain can be used to create secure and transparent voting systems.</li></ul><button  class='next-btn'}>Next</button>`,
          `<h2>Let’s wrap things up</h2><p>So, that’s the brief fundamentals ofblockchain techmology in a nutshell! It’s all about understanding the basics of what blockchain is, how it works, and why it’s important.</p><button  class='next-btn'}>Finish</button>`,
          `<div><h2>Do you want to take a quiz?</h2><button  class='next-btn'}>Yes</button><button  class='next-btn'}>No</button></div>`,
        ],
        quizQuestions: [
          `<h2>1. What is a blockchain?</h2><div><input type="radio" name="" id="" /><p>A type of cryptocurrency</p></div><div><input type="radio" name="" id="" /><p>A decentralized digital ledger</p></div><div><input type="radio" name="" id="" /><p>A centralized database</p></div><div><input type="radio" name="" id="" /><p>A type of computer network</p></div><button  class='next-btn'}>Next</button>`,
          `<h2>2. Which of the following is a key feature of blockchain technology?</h2><div><input type="radio" name="" id="" /><p>Centralized control</p></div><div><input type="radio" name="" id="" /><p>Immutability</p></div><div><input type="radio" name="" id="" /><p>High transaction fees</p></div><div><input type="radio" name="" id="" /><p>Limited scalability</p></div><button  class='next-btn'}>Next</button>`,
          `<h2>3. What is the primary purpose of a consensus mechanism in a blockchain?</h2><div><input type="radio" name="" id="" /><p>To increase transaction speed</p></div><div><input type="radio" name="" id="" /><p>To ensure all participants agree on the state of the ledger</p></div><div><input type="radio" name="" id="" /><p>To reduce the cost of transactions</p></div><div><input type="radio" name="" id="" /><p>To centralize control of the network</p></div><button  class='next-btn'}>Next</button>`,
          `<h2>4. Which of the following best describes a smart contract?</h2><div><input type="radio" name="" id="" /><p> A legal agreement between two parties</p></div><div><input type="radio" name="" id="" /><p>A self-executing contract with the terms directly written into code</p></div><div><input type="radio" name="" id="" /><p>A traditional paper contract</p></div><div><input type="radio" name="" id="" /><p>A type of cryptocurrency</p></div><button  class='next-btn'}>Finish</button>`,
        ],
      },
      {
        id: 3,
